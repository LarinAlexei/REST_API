...
class Project(models.Model):
    ...
    customer_project = models.ForeignKey(ApiUser, on_delete=models.SET_NULL, null=True,
                                         verbose_name='uid заказчик проекта')
...
class Executor(models.Model):
    ...
    user = models.ForeignKey(UserWorkingProject, on_delete=models.SET_NULL, null=True)
    add_date = models.DateTimeField(verbose_name='Дата добавления проекта', auto_now_add=True)
    last_modified = models.DateTimeField(verbose_name='Дата последнего изменения', auto_now=True)
